    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.update_delivery_volume', $deliveryVolume->id)}}" method="post" enctype='multipart/form-data'>
                            @csrf
                            <label for="">Название</label>
                            <input type="text" required name="name" value="{{$deliveryVolume->title}}">
                            <br>
                            <input type="submit" value="Изменить">
                            <br>
                            <br>
                            <a href="{{route('admin.data_index')}}">Вернутся</a>
                        </form>
                    </div>
                </div>
            </div>
