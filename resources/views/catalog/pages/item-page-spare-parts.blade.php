            ...
            <div class="cart-info-block container">
                ...
                <div class="item-information">
                    ...
                    <div class="cont-specifications">
                        <div class="cont">
                            <p>Состояние</p>
                            <span>{{ $advert->sparePartsAdvert->accessory_state }}</span>
                        </div>
                        <div class="cont">
                            <p>Объем доставки</p>
        ...
        <div class="tabs-mess">
            ...
            <div class="tabs__content active">
                <div class="container">
                    ...
                    {{--                                                <div class="setting-cont">--}}
                    {{--                                                    <p>Диаметр</p>--}}
                    {{--                                                    <span>{{$advert->sparePartsAdvert->diameter}} mm</span>--}}
                    {{--                                                </div>--}}
                    {{--                    </div>--}}
            ...
            <div class="tabs__content">
                <div class="container">
                    <ul class="item-suitable">
                        @foreach($advert->sparePartsAdvert->watchModels as $watchModel)
                            <li><a href="#">{{$watchModel->title}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
