            ...
            <div class="container-wrap">
                ...
                <div class="block-messages">
                    ...
                    <div class="chat-cont">
                        ...
                        <div id="chatd_block">
                            <chat :user_avatar="{{$user_avatar}}" :respondent_avatar="{{$respondent_avatar}}" :dialog_id="{{$currentDialog->id}}" :messages_list="{{ $messages  }}" :user_id="{{Auth::id()}}" :respondent_id="{{$currentDialog->advert->user_id}}"></chat>
                        </div>
