                        ...
                        <form action="" method="post">
                            ...
                            <span class="check-cont">
                                <label class="checkbox-other">
                                    <input type="radio" name="is_release_year_confirmed" value="1">
                                    <span>Приблизительно</span>
                                </label>
                                <label class="checkbox-other">
                                    <input type="radio" name="is_release_year_no_confirmed" checked value="0">
                    ...
                    <div class="tabs-item">
                        ...
                        <div class="block-data-cont">
                            <div class="text-cont">
                                ...
                                <div class="text-item">
                                    Ваши личные данные будут использованы исключительно для продажи артикулов на сайте и
                                    не
                                    будут опубликованы.
                                    <div class="img-cont">
                ...
                <div class="tabs__content active">
                    <div class="tabs-item">
                        ...
                        <div class="inline-cart">
                            ...
                            <div class="info-cart">
                                <a href="#/" class="cart-name">Hublot Big Bang 44MM Evolution Steel Ceramic Watch
                                    301.SM.1770.RX</a>
                                <div class="info-wrap">
                                    <div class="block">
                                        <div class="price">
                                    ...
                                    <div class="block-grid">
                                        <div class="item-infos">
                                            <p>ИИ номер:</p>
                                            <span>341.VL.4789.LR.1207.POP15</span>
                                        </div>
                                        <div class="item-infos">
                                            <p>Объем доставки:</p>
                                            <span>С оригинальными документами</span>
                                        </div>
                                        <div class="item-infos">
                                            <p>Местоположение:</p>
                                            <span>США, Florida, Aventura</span>
                                        </div>
                                        <div class="item-infos">
                                            <p>Диаметр:</p>
                                            <span>41 mm</span>
