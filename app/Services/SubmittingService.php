...
class SubmittingService
{
    ...
    public function getInfoArr(SubmittingRequest $request, Advert $advert)
    {
    ...
    public function getDraftInfoArr(Advert $advert)
    {
        $infoArr = $this->getPartInfoArr($advert);
        if ($advert) {
    ...
    public function getPartInfoArr(Advert $advert)
    {
